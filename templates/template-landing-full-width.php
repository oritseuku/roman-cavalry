...
?>
    ...
    <div class="pagewrap landingFull" style="<?php echo $bg_url; ?>">
        <header>
...
<div class="container">
	...
	<div id="primary" class="col-lg-12 landingBox">
		<main id="main" class="site-main" role="main">

		<?php
		while ( have_posts() ) : the_post();

			get_template_part( 'template-parts/content-landing-full-width', get_post_format() );
